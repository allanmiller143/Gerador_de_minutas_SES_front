  ...
  return (
    <aside className="hidden md:flex md:flex-col w-64 bg-gradient-sidebar text-sidebar-foreground border-r border-sidebar-border shrink-0">
      ...
      <div className="p-3 border-t border-sidebar-border">
        <button className="w-full flex items-center gap-3 px-3 py-2.5 rounded-md text-sm text-sidebar-foreground/80 hover:bg-sidebar-accent hover:text-sidebar-accent-foreground transition-colors">
